      ...
      const html = isPt 
        ? `
          <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
            <h2 style="color: #4f46e5; margin-bottom: 20px;">Sentimos sua falta no JOGALIBRE!</h2>
            ...
            <div style="margin: 30px 0; text-align: center;">
              <a href="https://jogalibre.com" style="background-color: #4f46e5; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">Acessar o JOGALIBRE</a>
            </div>
        ...
        : `
          <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
            <h2 style="color: #4f46e5; margin-bottom: 20px;">¡Te extrañamos en JOGALIBRE!</h2>
            ...
            <div style="margin: 30px 0; text-align: center;">
              <a href="https://jogalibre.com" style="background-color: #4f46e5; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">Acceder a JOGALIBRE</a>
            </div>
            <hr style="border: 0; border-top: 1px solid #eee; margin: 30px 0;" />
